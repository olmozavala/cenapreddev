...
$menuborer= $params->get('menuborer','#49525e');
...
#je_accord".$module->id.".je_acc > ul > li > a { border-left: 1px solid ".$menuborer."; border-right: 1px solid ".$menuborer."; border-top: 1px solid ".$menuborer."; color: ".$menulinkcolor."; background: ".$menucolor.";}
...
#je_accord".$module->id.".je_acc > ul > li.open > a { border-bottom: 1px solid ".$menuborer.";}
#je_accord".$module->id.".je_acc > ul > li:last-child > a,
#je_accord".$module->id.".je_acc > ul > li.last > a {border-bottom: 1px solid ".$menuborer.";}
...
#je_accord".$module->id.".je_acc ul ul li a { border-bottom: 1px solid ".$menuborer."; border-left: 1px solid ".$menuborer."; border-right: 1px solid ".$menuborer."; color: ".$menulinkcolorsub."; background: ".$menucolorsub.";}
...
#je_accord".$module->id.".je_acc ul ul li.has-sub > a::after { border-top: 2px solid ".$menuborer."; border-left: 2px solid ".$menuborer.";}
#je_accord".$module->id.".je_acc ul ul li.active > a::after,
#je_accord".$module->id.".je_acc ul ul li.open > a::after,
#je_accord".$module->id.".je_acc ul ul li > a:hover::after { border-color: ".$menuborer.";}
"; 
