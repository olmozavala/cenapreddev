...
image_name_increment = 6;           	//Indica el aumento en el nombre de la imagen
...
<table  cellspacing="0" width="100%">
       ...
       <img NAME="animation" src="<?php echo $ruta_completa; ?>000.png"  alt="<?php echo $ProductName; ?>" style="max-width:75%;max-height:78%;display: block;margin-left: auto; margin-right: auto " /> 
       <br>
       <HR>       
    <img src="../images/playbuttons/primero.png" width="30" height="30" onClick="go2image(first_image)"  />
